...
# 	#line = input()
# 	#freqTable1 = make_freq_table(line)
	

# 	freqTable1 = Counter({'a':1, 'b':2, 10:1})
# 	tree1 = make_tree(freqTable1)
# 	print(tree1)
# 	leftBran = tree1.left
# 	print(leftBran)
# 	lleftBran = leftBran.left
# 	rleftBran = leftBran.right
# 	print(lleftBran)
# 	print(lleftBran.left.value)
# 	print(lleftBran.right)

# 	print(rleftBran.value)
